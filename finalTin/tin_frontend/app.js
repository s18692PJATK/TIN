...
var $author$project$Main$BookRoute = {$: 'BookRoute'};
var $author$project$Main$CollectionRoute = {$: 'CollectionRoute'};
var $author$project$Main$UserRoute = {$: 'UserRoute'};
...
var $author$project$Main$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$url$Url$Parser$map, $author$project$Main$UserRoute, $elm$url$Url$Parser$top),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$BookRoute,
			$elm$url$Url$Parser$s('books')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$CollectionRoute,
			$elm$url$Url$Parser$s('collections'))
		]));
var $author$project$Main$GotBookMsg = function (a) {
	return {$: 'GotBookMsg', a: a};
};
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Main$toBooks = F2(
	function (model, _v0) {
		var bookModel = _v0.a;
		var bookMsg = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					currentPage: $author$project$Main$BookPage(bookModel)
				}),
			A2($elm$core$Platform$Cmd$map, $author$project$Main$GotBookMsg, bookMsg));
	});
var $author$project$Main$CollectionPage = function (a) {
	return {$: 'CollectionPage', a: a};
};
var $author$project$Main$GotCollectionMsg = function (a) {
	return {$: 'GotCollectionMsg', a: a};
};
var $author$project$Main$toCollections = F2(
	function (model, _v0) {
		var collectionModel = _v0.a;
		var collectionMsg = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					currentPage: $author$project$Main$CollectionPage(collectionModel)
				}),
			A2($elm$core$Platform$Cmd$map, $author$project$Main$GotCollectionMsg, collectionMsg));
	});
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					currentPage: $author$project$Main$UserPage(userModel)
				}),
			A2($elm$core$Platform$Cmd$map, $author$project$Main$GotUserMsg, userMsg));
	});
			...
			switch (_v0.a.$) {
				case 'BookRoute':
					...
					return A2(
						...
						model,
						$author$project$Book$init(_Utils_Tuple0));
				case 'CollectionRoute':
					var _v2 = _v0.a;
					return A2(
						$author$project$Main$toCollections,
						model,
						$author$project$Collection$init(_Utils_Tuple0));
				default:
					var _v3 = _v0.a;
					return A2(
						$author$project$Main$toUsers,
						model,
						$author$project$User$init(_Utils_Tuple0));
			}
		} else {
			return A2(
				$elm$core$Debug$log,
				'Not found page clicked ',
				_Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Main$init = F2(
	function (url, key) {
		return A2(
			...
			url,
			{
				currentPage: $author$project$Main$BookPage($author$project$Book$initialModel),
				key: key
			});
	});
...
var $author$project$Main$isActive = function (_v0) {
	var route = _v0.route;
	var page = _v0.page;
	var _v1 = _Utils_Tuple2(route, page);
	switch (_v1.a.$) {
		case 'UserRoute':
			if (_v1.b.$ === 'UserPage') {
				var _v2 = _v1.a;
...
var $author$project$Main$viewHeader = function (page) {
	...
	var logo = A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('GoodReads v2')
			]));
	var links = A2(
		$elm$html$Html$ul,
		_List_Nil,
		_List_fromArray(
			[
				...
				navLink,
				$author$project$Main$CollectionRoute,
				{caption: 'Collection', url: '/collections'}),
				A2(
				navLink,
				$author$project$Main$BookRoute,
				{caption: 'Book', url: '/books'})
			]));
	return A2(
		$elm$html$Html$nav,
		_List_Nil,
						...
						switch (_v0.$) {
							case 'UserPage':
								...
								return A2(
									...
									$author$project$User$view(userModel));
							case 'BookPage':
								var bookModel = _v0.a;
								return A2(
									$elm$html$Html$map,
									$author$project$Main$GotBookMsg,
									$author$project$Book$view(bookModel));
							case 'CollectionPage':
								var collectionModel = _v0.a;
								return A2(
									$elm$html$Html$map,
									$author$project$Main$GotCollectionMsg,
									$author$project$Collection$view(collectionModel));
							default:
								return $elm$html$Html$text('Page not found, check if the route is correct');
						}
					}()
					]))
			]),
